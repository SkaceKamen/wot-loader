	...
	public function __construct() {
		$this->itemsReader = new Items(
			...
			array(
				...
				'shell_damage_armor' => function ($element, $key) {
					return (int)$element->damage->armor;
				},
				'shell_damage_device' => function ($element, $key) {
					return (int)$element->damage->devices;
				},
				'shell_explosion_radius' => 'explosionRadius',
				'shell_tracer' => function ($element, $key) {
					return (string)$element->isTracer == 'true' ? 1 : 0;
				}
			),
			false
		);
